...
export const i18n = {
  zh: {
    ...
    serverRecoveryDesc: "注册邮箱后，如果同时忘记密码和安全问题答案，可以通过邮箱找回。",
    onlineTag: "在线",
    connectRegister: "连接并注册",
    emailPlaceholder: "您的邮箱地址",
    changePassword: "修改密码",
    changePasswordDesc: "修改主密码后，所有数据将使用新密码重新加密。",
    ...
    dataBackup: "数据备份",
    dataBackupDesc: "导出的文件包含加密后的密码数据，可用于备份或迁移。",
    exportData: "导出数据",
    importData: "导入数据",
    importModeMerge: "合并",
    ...
    // 自动备份
    autoBackup: "自动备份",
    autoBackupDesc: "定期自动备份数据到本地，防止数据丢失。",
    backupFreq: "备份频率",
    backupDaily: "每日",
    backupWeekly: "每周",
    backupMonthly: "每月",
    ...
    backupNow: "立即备份",
    backupReminder: "备份提醒",
    backupReminderTitle: "数据备份提醒",
    backupReminderDesc: "距离上次备份已过去较长时间，建议立即备份以防数据丢失。",
    backupLater: "稍后提醒",
    daysAgo: "天前",

    // 强制设置
    mandatorySetupTitle: "安全设置",
    mandatorySetupDesc: "为保障数据安全，请设置恢复选项。",
    completeSetup: "完成设置",
    skipNotAllowed: "必须完成安全设置才能继续",
    bothRequired: "请同时设置安全问题和恢复邮箱",
...
A: 目前需手动导出/导入同步，建议用云盘存储备份文件。`,
  ...
  en: {
    ...
    localRecoveryDesc: "Set a security question for local password recovery.",
    offlineTag: "Offline",
    ...
    autoBackupDesc: "Automatically backup data locally at regular intervals.",
    ...
    backupReminderDesc: "It's been a while since your last backup. Backup now to prevent data loss.",
    backupLater: "Remind Later",
    daysAgo: "days ago",

    // Mandatory Setup
    mandatorySetupTitle: "Security Setup",
    mandatorySetupDesc: "For data security, please configure recovery options.",
    completeSetup: "Complete Setup",
    skipNotAllowed: "Security setup required to continue",
    bothRequired: "Please set both security question and recovery email",
