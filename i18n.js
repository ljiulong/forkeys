...
const i18n = {
        zh: {
                ...
                mandatorySetupDesc: "为保障数据安全，请设置恢复选项。忘记密码时可通过这些方式找回。",
                completeSetup: "完成设置",
...
A: 目前需手动导出/导入同步，建议用云盘存储备份文件。`,
        ...
        en: {
                ...
                mandatorySetupDesc: "For data security, please configure recovery options. These help recover your vault if you forget the password.",
